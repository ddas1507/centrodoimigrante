...
<body id="top" class="loading">
	...
	<div class="page-header clearfix">
		...
		<div class="page-title">	
			<h2>Dasellus ac nibh urna donec ac urna</h2>
				...
				<div class="blog-entry clearfix">
					...
					<div class="blog-info">
						...
						<ul class="blog-meta">
							...
							<li><strong>Comments</strong> 3</li>
						</ul>
					</div>
					
					<div class="blog-content blog-content-single">	
						<a href="#"><img src="images/04_blog_single_image.png" alt="" class="blog-image" /></a>
						
						<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eget velit eu ipsum viverra dapibus. Integer pretium nisi at eros tincidunt porta. Pellentesque feugiat, odio non imperdiet vestibulum, erat orci viverra eros, ut pellentesque ante sem in lectus. Donec purus nisl, tempor ut condimentum nec, blandit vitae lacus. Mauris et arcu arcu. Morbi libero urna, tristique at rutrum id, suscipit eu metus.</p>
						<blockquote>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit donec nunc mi, ultricies eget aliquet interdum, dapibus in arcu. Praesent facilisis congue nulla vitae semper</p>
						</blockquote>
					...
					<div id="respond">
						...
						<ul class="comments">
							...
							<li class="comment-entry clearfix">
								...
								<div class="comment-right">
									...
									<p class="comment-info">Admin <span>Aug 6, 2012 at 9:37 am </span></p>
									<p class="comment-text">Duis ut mauris ut lacus tincidunt viverra. Morbi ornare tellus vitae velit molestie ullamcorper. Mauris sodales congue est, nec tristique nulla vulputate eu. Aliquam at nulla ut diam scelerisque dictum eu sit amet lectus. </p>
						...
						<form action="#" id="commentform" method="post">
							...
							<div class="field-row">
								<label for="message_text">Comment <span>(required)</span></label>
								<textarea name="message" id="message_text" class="text_input" cols="60" rows="9"></textarea>
							</div>

							<input class="button1" type="submit" value="Submit Comment" id="submit" name="submit">
