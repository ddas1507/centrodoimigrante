...
<!-- BEGIN body -->
<body id="top" class="loading teachers2-page">
	...
	<div class="page-header clearfix">
		...
		<div class="breadcrumbs">
			<p><a href="index.html">Home</a> &#187; Teachers #2</p>
		</div>
		...
		<div class="main-content-full page-content">
			...
			<div class="inner-content-wrapper">
				...
				<ul class="teacher-4">
					...
					<li>
						<img src="images/12_teacher_image_b.png" alt="" />
						<h3 class="teacher-title">Kate Goldman<span>Lecturer</span></h3>
						<p>Aenean interdum nisi sit amet felis auctor a vestibulum diam lacinia quisque nec nibh at.</p>
					...
					<li>
						<img src="images/12_teacher_image_b.png" alt="" />
						<h3 class="teacher-title">Lily Holland<span>Program Coordinator</span></h3>
						<p>Aenean interdum nisi sit amet felis auctor a vestibulum diam lacinia quisque nec nibh at.</p>
						<ul class="teacher-contact">
							<li><span class="contact-phone">1-800-888-8888</span></li>
							<li><span class="contact-email">email@website.com</span></li>
					...
					<li>
						<img src="images/12_teacher_image_b.png" alt="" />
						<h3 class="teacher-title">John Smith<span>Assistant Lecturer</span></h3>
						<p>Aenean interdum nisi sit amet felis auctor a vestibulum diam lacinia quisque nec nibh at.</p>
						<ul class="teacher-contact">
							<li><span class="contact-phone">1-800-888-8888</span></li>
							<li><span class="contact-email">email@website.com</span></li>
