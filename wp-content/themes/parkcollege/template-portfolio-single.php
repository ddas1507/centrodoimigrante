			...
			<div class="inner-content-wrapper">
				...
				<div class="page-slider portfolio-slider clearfix">
					...
					<ul class="slides slide-page-loader">
						<li><img src="images/10_portfolio_single_image.png" alt="" /></li>
						<li><img src="images/10_portfolio_single_image.png" alt="" /></li>
					</ul>
				...
				<ul class="portfolio-single-cols">
					...
					<li class="col-1">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dolor nisl, pharetra eu vehicula vel, vulputate et justo. Morbi ut nulla massa. Nunc commodo, leo quis lacinia rutrum, erat purus luctus augue, sed accumsan nisl diam vel velit. Duis eleifend mauris eu lacus placerat molestie. Pellentesque tellus sem, mattis eget blandit sit amet, consectetur id lorem. Donec at ipsum lorem, at fermentum eros. Cras ac neque non lectus gravida suscipit eget eu urna. Vestibulum sollicitudin ultrices consectetur. Donec sit amet ante lectus, quis lacinia turpis. In consectetur mauris iaculis metus dignissim quis porta eros venenatis.</p>
					</li>
					...
					<li class="col-2">
						...
						<ul class="portfolio-details">
							<li class="clearfix"><strong>Client</strong> <span>Themeforest</span></li>
							<li class="clearfix"><strong>Date</strong> <span>1st June, 2013</span></li>
							<li class="clearfix"><strong>Tags</strong> <span>College, Education, Learning</span></li>
						</ul>
