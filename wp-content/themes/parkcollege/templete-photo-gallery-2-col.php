...
<body id="top" class="loading">
	...
	<div class="page-header clearfix">
		...
		<div class="page-title">	
			<h2>Gallery - 2 Columns</h2>
			<div class="page-title-block"></div>
		</div>
		
		<div class="breadcrumbs">
			<p><a href="index.html">Home</a> &#187; Gallery - 2 Columns</p>
		</div>
				...
				<div id='gallery-1' class='gallery gallery-columns-2'>
					...
					<dl class='gallery-item'>	
						<dt class='gallery-icon'>
							<a href="images/09_gallery_image.png" rel="prettyPhoto[gallery]"><img src="images/09_gallery_image.png" alt="" /></a>
						</dt>
					</dl>
