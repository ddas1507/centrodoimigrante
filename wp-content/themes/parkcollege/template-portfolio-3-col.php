...
<!-- BEGIN body -->
<body id="top" class="loading portfolio-3-col-page">
	...
	<div class="page-header clearfix">
		...
		<div class="breadcrumbs">
			<p><a href="index.html">Home</a> &#187; Portfolio - 3 Columns</p>
		</div>
	...
	<div class="content-wrapper page-content-wrapper clearfix">
		...
		<div class="main-content-full page-content">
			...
			<div class="inner-content-wrapper">
					...
					<li class="col">	
						...
						<div class="page-slider clearfix">
							...
							<ul class="slides slide-page-loader">
								<li><img src="images/09_gallery_image.png" alt="" /></li>
								<li><img src="images/09_gallery_image.png" alt="" /></li>
							</ul>
						...
						<div class="title1 clearfix">
							<h4><a href="#">Mauris ultrices sapien et augue</a></h4>
							<div class="title-block"></div>
						</div>
						<p>Phasellus semper, ante at tempus dapibus, quam dui convallis orci, in dapibus erat mi eu nisi. Curabitur eu nibh ac lectus tempor pharetra. Praesent id turpis purus. Integer sem mi.</p>
					</li>
					
					<li class="col">	
						<a href="#"><img src="images/09_gallery_image.png" alt="" class="portfolio-image" /></a>
						<div class="title1 clearfix">
							<h4><a href="#">Mauris ultrices sapien et augue</a></h4>
							<div class="title-block"></div>
						</div>
				...
				<div class="pagination-wrapper dotted-pagination">
