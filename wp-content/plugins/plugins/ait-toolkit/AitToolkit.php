...
class AitToolkit
{
	...
	public function onInit()
	{
		...
		add_filter('pll_get_post_types', array($this, 'addCptsToPolylang'));
		add_filter('pll_get_taxonomies', array($this, 'addTaxsToPolylang'));
	}



	public function addCptsToPolylang($cpts)
	{
		$aitCpts = self::getManager('cpts')->getTranslatable('list');

		return array_merge($cpts, $aitCpts);
	}



	public function addTaxsToPolylang($taxs)
	{
